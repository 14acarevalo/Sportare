...
<title>PaginaPrincipalCoordinador</title>
 <link rel="stylesheet" href="PagMenuServiciosUsuario.css">
</head>
<body>
<header>
    ...
    <div class="presentacion">
        <p class="Bienvenidos"><h1>Bienvenido a <span class="nombremarca">SPORTARE</span></h1>
        <p>Aqui encontrarás toda nuestras instalaciones, reserva en la que estés interesado/a </p>
     </div>
</div>
</header>
...
<main>
<section>
<div class="panelCoordinador">
    
    <a href="PagMenuServiciosUsuario.jsp" class=""><img class="insertar" src="iconosCoordinador/REALIZARreserva.jpg" alt="perfiles" width="50%" height="50%"></a>
    <a href="VisualServicioUsuario.jsp" ><img class="listar" src="iconosCoordinador/LISTARreservas.jpg" alt="servicioDeportivo" width="50%" height="50%"> </a>

...
<header>
    ...
    <div class="menu"> 
        <ul>
            ...
            <li><a href="Pag_perfil_usuario.html">Página Usuario</a></li>
            <li><a href="Pag_informacion.html">Informacion</a></li>
            <li><a href="PagEditarUsuarioIndividual.jsp">Refrescar pantalla</a></li>
        </ul>
    </div>
    <div class="presentacion">
        <h1>Bienvenido a <span class="nombremarca">TUS DATOS</span></h1>
...
function pintarResultados(usuarios) {
    ...
    html += "<tr><td>Password</td><td>" + usuarios.password + "</td></tr>";
    ...
    html += "<tr><td>Calle</td><td>" + usuarios.calle + "</td></tr>";
    ...
    html += "<tr><td>Saldo</td><td>" + usuarios.saldo + "</td></tr>";
    html += "<tr><td>Permiso</td><td>" + usuarios.permiso + "</td></tr>";
    html += "<tr><td>Editar</td><td><a href='UsuarioModificaDatos.jsp?idUsuario=" + usuarios.idUsuario + "&op=2'>Editar</a></td></tr>";

...
<header>
    ...
    <div class="menu"> 
        <ul>
            <li> <a href="PaginaPrincipalUsuario.html">Inicio</a></li>
...
<div class="panelUsuario">
    ...
    <a href="PagMenuServiciosUsuario.html" ><img class="servicioDeportivo" src="PerfilUsuario/instalacion.jpg" alt="servicioDeportivo" width="58%" height="58%"> </a>
	...
	<a href="PagConsultarSaldoUsuario.html"><img class="monedero" src="iconosCoordinador/monederooo.jpg" width="58%" height="58%"alt=""></a>

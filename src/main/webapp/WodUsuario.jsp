...
<div class="logo"> <img src="PicturesPortada/SPORTARE.png" alt="Logo" width="100px" height="100px"></div>
    ...
    <main>
        <div class="instalaciones">
         <form name="Wod" action="ClaseReservaConAforoUsuario" method="post">
       ...
       <br>
                ...
                <select id="dia" name="dia" required>
                    ...
                    <option value="3">Miercoles 3</option>
                    <option value="4">Jueves 4</option>
                    <option value="5">Viernes 5</option>
                    <option value="6">Sábado 6</option>
                    
                    <option value="8">Lunes 8</option>
                    <option value="9">Martes 9</option>
                    <option value="10">Miercoles 10</option>
                    <option value="11">Jueves 11</option>
                    <option value="12">Viernes 12</option>
                    <option value="13">Sábado 13</option>
                    
                    <option value="14">Lunes 14</option>
                    <option value="15">Martes 15</option>
                    <option value="16">Miercoles 16</option>
                    <option value="17">Jueves 17</option>
                    <option value="18">Viernes 18</option>
                    <option value="19">Sábado 19</option>
                    
                    <option value="21">Lunes 21</option>
                    <option value="22">Martes 22</option>
                    <option value="23">Miercoles 23</option>
                    <option value="24">Jueves 24</option>
                    <option value="25">Viernes 25</option>
                    <option value="26">Sábado 26</option>
                    
                    <option value="28">Lunes 28</option>
                    <option value="29">Martes 29</option>
                    <option value="30">Miercoles 30</option>

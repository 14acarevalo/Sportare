...
/**
 * Servlet implementation class ClaseUsuarioModificaSuPerfil
 */
public class ClaseUsuarioModificaSuPerfil extends HttpServlet {
     ...
     */
    public ClaseUsuarioModificaSuPerfil() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Usuario a = new Usuario (nombre, apellidos, correoElectronico, password, fechaNacimiento, dni, nacionalidad, ciudad, direccion, calle, telefono, codigoPostal, genero);
	 ...
	 try {
        ...
        // Redirige al usuario de vuelta al formulario
    		   ...
    		   request.getRequestDispatcher("PagEditarUsuarioIndividual.jsp").forward(request, response);
    	   }
